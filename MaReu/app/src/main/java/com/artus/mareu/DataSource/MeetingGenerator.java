...
public abstract class MeetingGenerator {
    ...
    public static List<Meeting> PLANIFIED_MEETINGS = Arrays.asList(
            ...
            new Meeting(3, "le concepte de front-Back",
                    LocalDateTime.of(2023, 7,12, 15,0),"Eclair", new ArrayList<>(Arrays.asList("fred@caramail.fr", "francois@lycos.fr","michel@caramail.fr"))),
            new Meeting(4, "Le pot au feu",
                    LocalDateTime.of(2023, 7,13, 9,0),"Froyo",new ArrayList<>(Arrays.asList("patrick@caramail.fr", "gontrand@lycos.fr","michel@caramail.fr"))),
            new Meeting(5, "le Data Binding",
                    LocalDateTime.of(2023, 7,12, 11, 15),"Gingerbread", new ArrayList<>(Arrays.asList("michel@caramail.fr", "francois@lycos.fr","fred@caramail.fr"))),
